...
export const defaultLight: AimdThemeTokens = {
  ...
  codeBlock: {
    ...
    shell: 'rgba(248, 250, 252, 0.72)',
    chipText: '#0f172a',
    chipSurface: 'rgba(255,255,255,0.88)',
    headerSurface: 'linear-gradient(180deg, rgba(255,255,255,0.92) 0%, rgba(255,255,255,0.72) 100%)',
    flowSurface: 'linear-gradient(180deg, rgba(255,255,255,0.52) 0%, rgba(248,250,252,0.20) 100%)',
    shadow: '0 14px 34px rgba(15, 23, 42, 0.06)',
    neutral: {
      accent: '#475467',
      accentSoft: 'rgba(71, 84, 103, 0.08)',
      border: 'rgba(148, 163, 184, 0.22)',
      surface: 'linear-gradient(180deg, rgba(255,255,255,0.98) 0%, rgba(248,250,252,0.98) 100%)',
    },
    client: {
      accent: '#0f766e',
      accentSoft: 'rgba(15, 118, 110, 0.10)',
      border: 'rgba(15, 118, 110, 0.18)',
      surface: 'linear-gradient(180deg, rgba(248,252,251,0.98) 0%, rgba(241,248,247,0.98) 100%)',
    },
    server: {
      accent: '#b45309',
      accentSoft: 'rgba(180, 83, 9, 0.10)',
      border: 'rgba(180, 83, 9, 0.18)',
      surface: 'linear-gradient(180deg, rgba(255,251,245,0.98) 0%, rgba(250,247,242,0.98) 100%)',
    },
  },
  syntax: {
    punctuation: '#059669',
...
export const defaultDark: AimdThemeTokens = {
  ...
  codeBlock: {
    ...
    shell: 'rgba(15, 23, 42, 0.42)',
    chipText: '#f8fafc',
    chipSurface: 'rgba(15, 23, 42, 0.22)',
    headerSurface: 'linear-gradient(180deg, rgba(15,23,42,0.52) 0%, rgba(15,23,42,0.28) 100%)',
    flowSurface: 'linear-gradient(180deg, rgba(15,23,42,0.36) 0%, rgba(15,23,42,0.18) 100%)',
    shadow: '0 14px 34px rgba(2, 6, 23, 0.28)',
    neutral: {
      accent: '#d0d8e4',
      accentSoft: 'rgba(148, 163, 184, 0.16)',
      border: 'rgba(148, 163, 184, 0.24)',
      surface: 'linear-gradient(180deg, rgba(22,31,44,0.98) 0%, rgba(15,23,42,0.98) 100%)',
    },
    client: {
      accent: '#7de3d6',
      accentSoft: 'rgba(45, 212, 191, 0.16)',
      border: 'rgba(45, 212, 191, 0.28)',
      surface: 'linear-gradient(180deg, rgba(15,42,40,0.98) 0%, rgba(15,33,35,0.98) 100%)',
    },
    server: {
      accent: '#f7c47b',
      accentSoft: 'rgba(251, 191, 36, 0.16)',
      border: 'rgba(245, 158, 11, 0.28)',
      surface: 'linear-gradient(180deg, rgba(44,30,16,0.98) 0%, rgba(34,24,17,0.98) 100%)',
    },
  },
  syntax: {
    punctuation: '#34D399',
